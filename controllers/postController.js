...
exports.createPostPostController = async (req, res, next) => {
    ...
    if(req.file) {
        post.thumbnail = `/uploads/postThumbnail/${req.file.filename}`
    }
...
exports.editPostPostController = async (req, res, next) => {
    ...
    try {
        ...
        if(req.file) {
            thumbnail = `uploads/postThumbnail/${req.file.filename}`
        }
...
exports.deletePostGetController = async (req, res, next) => {
	...
	await fs.unlinkSync("/uploads/postThumbnail/" + post.thumbnail );
